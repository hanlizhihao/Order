...
public class PlanAdapter extends BaseExpandableListAdapter {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup viewGroup) {
        LinearLayout linearLayouts=new LinearLayout(context);//整个布局
        LinearLayout linerLayoutOne=new LinearLayout(context);//第一行数据
        LinearLayout linerLayoutTwo=new LinearLayout(context);//第二行数据
